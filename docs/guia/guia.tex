...
\begin{figure}[H]
  \centering
  \subfigure[splash screen]{\fbox{\includegraphics[scale=0.11]{img/splash.png}}}
  \hspace{0.5cm}
  \subfigure[inicio de sesión]{\fbox{\includegraphics[scale=0.11]{img/inicio_sesion.png}}}
  \hspace{0.5cm}
  \subfigure[registro]{\fbox{\includegraphics[scale=0.11]{img/registro.png}}}
...
\begin{figure}[H]
  \centering
  \subfigure[Map screen]{\fbox{\includegraphics[scale=0.11]{img/map_default.png}}}
  \hspace{0.5cm}
  \subfigure[seleccionar destino]{\fbox{\includegraphics[scale=0.11]{img/map_destino.png}}}
  \hspace{0.5cm}
  \subfigure[seleccionar medio de transporte]{\fbox{\includegraphics[scale=0.11]{img/map_transporte.png}}}
...
\begin{figure}[H]
  \centering
  \subfigure[ruta andando]{\fbox{\includegraphics[scale=0.11]{img/map_caminar.png}}}
  \hspace{0.5cm}
  \subfigure[ruta en bici]{\fbox{\includegraphics[scale=0.11]{img/map_bici.png}}}
  \hspace{0.5cm}
  \subfigure[ruta en bus]{\fbox{\includegraphics[scale=0.11]{img/map_bus.png}}}
...
\begin{figure}[H]
  \centering
  \subfigure[usuario y contraseña]{\fbox{\includegraphics[scale=0.11]{img/perfil_usuario.png}}}
  \hspace{0.5cm}
  \subfigure[editar usuario]{\fbox{\includegraphics[scale=0.11]{img/perfil_edit.png}}}
  \hspace{0.5cm}
  \subfigure[sesión con Google]{\fbox{\includegraphics[scale=0.11]{img/perfil_google.png}}}
  \hspace{0.5cm}
  \subfigure[sesión anónima]{\fbox{\includegraphics[scale=0.11]{img/perfil_anonimo.png}}}
...
\begin{figure}[H]
  \centering
  \subfigure[tema claro]{\fbox{\includegraphics[scale=0.11]{img/ajustes_claro.png}}}
  \hspace{0.5cm}
  \subfigure[tema oscuro]{\fbox{\includegraphics[scale=0.11]{img/ajustes_oscuro.png}}}
  \hspace{5cm}
  \subfigure[idioma en inglés]{\fbox{\includegraphics[scale=0.11]{img/ajustes_english.png}}}
  \hspace{0.5cm}
  \subfigure[idioma en euskera]{\fbox{\includegraphics[scale=0.11]{img/ajustes_euskara.png}}}
