...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[scale=0.15]{../.img/splash.png}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\includegraphics[scale=0.15]{../.img/map_default.png}}
...
\begin{figure}[htbp]
  \centering
  \subfigure[seleccionar destino]{\fbox{\includegraphics[scale=0.11]{../.img/map_select_dest.png}}}
  \hspace{0.5cm}
  \subfigure[seleccionar medio de transporte]{\fbox{\includegraphics[scale=0.11]{../.img/map_select_transport.png}}}
...
\begin{figure}[htbp]
  \centering
  \subfigure[usuario y contraseña]{\fbox{\includegraphics[scale=0.11]{../.img/perfil_anonimo.png}}}
  \hspace{0.5cm}
